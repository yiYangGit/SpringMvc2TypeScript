...
public class ExtendedTsCodeGenerationsTest extends TsCodeGenerationsTest{
    ...
    public void configurableTsModulesConverter() throws IOException {
        ...
        packagesMap.put("example.model.core", new TSModule("core", Paths.get("app/sdk/model"), false));
        packagesMap.put("example.model", new TSModule("model", Paths.get("app/sdk/model"), false));
        packagesMap.put("example.model.enums", new TSModule("model-enums", Paths.get("app/sdk/enums"), false));
        TSModule servicesModule = new TSModule("services", Paths.get("app/sdk/services"), false);
        packagesMap.put("example.biz.core", servicesModule);
    ...
    public void complexRestClassCondition() throws IOException {
        ...
        tsGenerator.setRestClassesCondition(new AndFilterOperator(Arrays.asList(new ExtendsJavaTypeFilter(Object.class), annotationConditions)));
