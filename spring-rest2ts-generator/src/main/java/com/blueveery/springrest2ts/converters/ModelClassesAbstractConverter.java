...
public abstract class ModelClassesAbstractConverter extends ClassConverter<ModelConversionExtension>{
    ...
    protected LinkedHashSet<Property> getClassProperties(Class javaClass, ObjectMapper objectMapper) {
        ...
        return new LinkedHashSet<Property>(propertyMap.values());
    }
