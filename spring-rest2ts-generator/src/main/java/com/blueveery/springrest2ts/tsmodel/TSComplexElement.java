...
public abstract class TSComplexElement extends TSScopedElement implements IDecorated, IParameterizedWithFormalTypes {
    private LinkedHashSet<TSField> tsFields = new LinkedHashSet<>();
    private LinkedHashSet<TSMethod> tsMethods = new LinkedHashSet<>();
    ...
    public LinkedHashSet<TSField> getTsFields() {
        return tsFields;
    }
    ...
    private void writeFields(BufferedWriter writer, LinkedHashSet<TSField> fieldList) throws IOException {
